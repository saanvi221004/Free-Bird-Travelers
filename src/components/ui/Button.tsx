      ...
      <button
        className={cn(
          ...
          // Variants
          {
            ...
            'border-2 border-primary-600 text-primary-600 hover:bg-primary-600 hover:text-white focus:ring-primary-500 hover:ring-1 hover:ring-primary-600': variant === 'outline',
